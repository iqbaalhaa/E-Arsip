        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                @if(Auth::check() && Auth::user()->role === 'admin')
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link" href="#"
                            aria-expanded="false"><i data-feather="database" class="feather-icon"></i><span
                                class="hide-menu">Manajemen Database</span></a>
                    </li>
                    <li class="sidebar-item"> <a class="sidebar-link" href="#"
                ...
                @elseif(Auth::check() && Auth::user()->role === 'pegawai')
                    <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ route('pegawai.dashboard') }}"
                            aria-expanded="false"><i data-feather="home" class="feather-icon"></i><span
                                class="hide-menu">Dashboard Pegawai</span></a></li>
