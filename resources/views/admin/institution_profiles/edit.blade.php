        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('institution-profiles.update', $institutionProfile->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" value="{{ old('name', $institutionProfile->name) }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" rows="3"
                                placeholder="Masukkan Alamat" required>{{ old('address', $institutionProfile->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('field') is-invalid @enderror" id="field"
                                name="field" value="{{ old('field', $institutionProfile->field) }}"
                                placeholder="Masukkan Bidang / Unit Kerja" required>
                            @error('field')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('contact') is-invalid @enderror" id="contact"
                                name="contact" value="{{ old('contact', $institutionProfile->contact) }}"
                                placeholder="Masukkan Kontak Resmi (Telp/Email)" required>
                            @error('contact')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @if ($institutionProfile->logo)
                                <div class="mb-2">
                                    <img src="{{ asset('File/' . $institutionProfile->logo) }}" alt="Logo Saat Ini"
                                        class="img-thumbnail" style="max-width: 150px;">
                                </div>
                            @endif
                            <input type="file" class="form-control-file @error('logo') is-invalid @enderror"
                                id="logo" name="logo">
                            <small class="form-text text-muted">Biarkan kosong jika tidak ingin mengubah logo. Format: jpg,
                                jpeg, png. Maksimal 2MB.</small>
                            @error('logo')
                        ...
                        <div class="form-actions mt-4">
                            <button type="submit" class="btn btn-primary"> <i data-feather="save" class="feather-icon"></i>
                                Update</button>
