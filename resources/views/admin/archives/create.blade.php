                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('type') is-invalid @enderror" id="type"
                                        ...
                                        <option value="Laporan" {{ old('type') == 'Laporan' ? 'selected' : '' }}>Laporan
                                        </option>
                                        <option value="Gambar Teknis"
                                            {{ old('type') == 'Gambar Teknis' ? 'selected' : '' }}>Gambar Teknis</option>
                                        <option value="Surat" {{ old('type') == 'Surat' ? 'selected' : '' }}>Surat
                                        </option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
